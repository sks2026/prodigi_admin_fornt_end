...
export default function Oregistration({ fun, ID, organizerData }) {
  ...
  const fetchBankAccounts = async () => {
    try {
      ...
      const url = `https://prodigiedu.com/api/competitions/bankaccount/${organizerId}`;
  ...
  const fetchRegistrationData = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://prodigiedu.com/api/competitions/registration/${competitionId}`, requestOptions);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.log('🌐 Making API call to:', `https://prodigiedu.com/api/competitions/registration/${competitionId}`);
      const response = await fetch(`https://prodigiedu.com/api/competitions/registration/${competitionId}`, requestOptions);
