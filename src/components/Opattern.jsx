...
const OPattern = ({ fun, ID }) => {
  ...
  useEffect(() => {
    const getPattern = async () => {
      try {
        ...
        const response = await fetch(`https://prodigiedu.com/api/competitions/getpattern/${competitionId}`, requestOptions);
        const result = await response.json();
  ...
  const savePattern = async () => {
    try {
      ...
      const response = await fetch(`https://prodigiedu.com/api/competitions/updatepattern/${competitionId}`, requestOptions);
