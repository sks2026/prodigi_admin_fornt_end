  ...
  const getOverview = async () => {
    ...
    try {
      const response = await fetch(
        `https://prodigiedu.com/api/competitions/getoverview/${competitionId}`,
        {
          method: "GET",
          redirect: "follow",
        }
      ...
      if (result.success && result.data) {
        ...
        if (fetchedData.image) {
          const imageUrl = fetchedData.image.startsWith("http")
            ? fetchedData.image
            : `https://prodigiedu.com${fetchedData.image}`;
  ...
  const handleSave = useCallback(async () => {
    try {
      ...
      const url = competitionId
        ? `https://prodigiedu.com/api/competitions/updateoverview/${competitionId}`
        : `https://prodigiedu.com/api/competitions/overview`;
