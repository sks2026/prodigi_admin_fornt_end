...
const ModifyMobileRequest = ({ onBack, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const verifyResponse = await fetch('https://prodigiedu.com/api/users/verify-user', {
        method: 'POST',
        headers: {
      ...
      // Create the request
      const requestResponse = await fetch(`https://prodigiedu.com/api/customer-requests/create/${verifyData.data.userId}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
