...
const CustomerOverview = ({ customer, onNavigate }) => {
  ...
  const fetchCustomerRequests = async () => {
    ...
    try {
      ...
      const apiUrl = `https://prodigiedu.com/api/customer-requests/my-requests/${customerId}`;
  ...
  const toggleRequestStatus = async (referenceId) => {
    ...
    try {
      const apiUrl = `https://prodigiedu.com/api/customer-requests/${referenceId}/toggle-status/${customerId}`;
